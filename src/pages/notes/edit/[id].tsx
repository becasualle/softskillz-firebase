        ...
        <div className={styles.createPostPage}>
            <div className={styles.cpContainer}>
                ...
                <div className={styles.inputGp}>
                    ...
                    <input type="text" placeholder='Заголовок...' value={note.title} id='title' name='title' onChange={(e) => setNote({ ...note, title: e.target.value })} />
                </div>
                <div className={styles.inputGp}>
                    <label htmlFor="post">Ситуация</label>
                    <textarea placeholder='Ситуация...' value={note.text} id='post' name='post' onChange={(e) => setNote({ ...note, text: e.target.value })} />
                </div>
